...
//		'discoURL' => NULL,
  ...
  'drupalauth-userpass' => array(
    'drupalauth:External',
    //'cookie_name' => 'SimpleSAMLAuthToken',

    // The filesystem path of the Drupal directory.
    'drupalroot' => !empty($_ENV['AH_SITE_NAME']) ? '/var/www/html/' . $_ENV['AH_SITE_NAME'] . '/docroot' : '/var/www/cypresscom/docroot',
    ...
    'drupal_login_url' => 'https://' . $_SERVER["HTTP_HOST"] . '/user',

    // Which attributes should be retrieved from the Drupal site.
    // If other column is needed except value than use this format to specify
    // column name (field_name:column_name).

    'attributes' => array(
      array('drupaluservar' => 'uid',                     'callit' => 'uid'),
      array('drupaluservar' => 'name',                    'callit' => 'username'),
      array('drupaluservar' => 'mail',                    'callit' => 'mail'),
      array('drupaluservar' => 'field_user_first_name',   'callit' => 'firstName'),
      array('drupaluservar' => 'field_user_last_name',    'callit' => 'lastName'),
      array('drupaluservar' => 'field_user_country:iso2', 'callit' => 'country'),
      array('drupaluservar' => 'field_state',             'callit' => 'state'),
      array('drupaluservar' => 'field_user_company_name', 'callit' => 'company'),
      array('drupaluservar' => 'ldap_user_current_dn',    'callit' => 'ldap'),
