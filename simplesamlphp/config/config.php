...
$config = array (
  ...
  'baseurlpath'           => 'simplesaml/',
	 ...
	 */
	'auth.adminpassword'		=> 'xMqVyRXmz6jHJsb',
	 ...
	 */
	'secretsalt' => 'iurph6tj4tl7494dqqkofdzsn7q5im6a',
	 ...
	 * syntaxes.
	 */
	'store.sql.dsn' => 'mysql:host=staging-10582;dbname=cypresscomstgsfdc',

	/*
	 * The username and password to use when connecting to the database.
	 */
	'store.sql.username' => 's26680',
	'store.sql.password' => 'apmQVWvpLbhkuc4',
...
if (!empty($_ENV['AH_SITE_NAME'])) {
  ...
  switch ($_ENV['AH_SITE_NAME']) {
    case 'cypresscomdev':
      $config['store.sql.dsn'] = 'mysql:host=staging-10582;dbname=cypresscomstg';
      $config['store.sql.username'] = 's11354';
      $config['store.sql.password'] = '4G23LkENf3jiFnz';
      break;
    case 'cypresscomdev2':
      $config['store.sql.dsn'] = 'mysql:host=staging-10582;dbname=cypresscomstg';
      $config['store.sql.username'] = 's11354';
    ...
    case 'cypresscom':
      ...
      break;
    case 'cypresscomstgsfdc':
      $protocol = 'https://';
      $config['store.sql.dsn'] = 'mysql:host=staging-10582;dbname=cypresscomstgsfdc';
      $config['store.sql.username'] = 's26680';
      $config['store.sql.password'] = 'apmQVWvpLbhkuc4';
      break;
    default:
      $config['store.sql.dsn'] = 'mysql:host=localhost;dbname=cypress_saml';
      $config['store.sql.username'] = 'root';
      $config['store.sql.password'] = '1234';
      break;
  }
